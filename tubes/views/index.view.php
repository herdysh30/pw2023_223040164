...
$result = mysqli_query($conn, "SELECT * FROM song, pop, jpop,kpop");
$song = query("SELECT * FROM song"); 
$pop = query("SELECT * FROM pop"); 
$j_pop = query("SELECT * FROM jpop"); 
$k_pop = query("SELECT * FROM kpop"); 
...
<div class="hero-area">
    ...
    <div class="tab-content" id="pills-tabContent" data-aos="fade-right">
        ...
        <!-- Menu 2 -->
        <div class="tab-pane fade container" id="pills-trending" role="tabpanel" aria-labelledby="pills-trending-tab" tabindex="0">
        ...
        <!-- Menu 3 -->
          <div class="tab-pane fade container" id="pills-new" role="tabpanel" aria-labelledby="pills-new-tab" tabindex="0">
            <div class="text-white row">
...
<section class="genre">
  ...
  <div class="container">
      <div class="row" data-aos="fade-right">
        <div class="col " >
          <h2 class="text-black" id="genre">Dengarkan Musik Berdasarkan Genre</h2>
        </div>
      </div>
      <!-- List Musik Kecil -->
      <!-- List Menu -->
      <div class=" text-black ">
          ...
          <div class="tab-content" id="pills-tabContent" data-aos="fade-right">
          <!-- Menu 1 -->
            <div class="tab-pane fade show active container" id="pills-jpop" role="tabpanel" aria-labelledby="pills-jpop-tab" tabindex="0">
              <div>
              <?php foreach($pop as $pop): ?>
                <div class="small-song-genre ms-4 col-md-8 row align-items-center">
                  <div class="col-1 h3"></div>
                    <div class="col d-flex">
                      <img class="rounded m-1" src="img/music/pop/<?php echo $pop['img']; ?>" style="width:50px;height:50px;object-fit:cover;">
                        <div class="ms-1 mt-1">
                          <div><?= $pop['judul']; ?></div>
          ...
          <!-- Menu 2 -->
          <div class="tab-pane fade container" id="pills-pop" role="tabpanel" aria-labelledby="pills-pop-tab" tabindex="0">
            <div>
            <?php foreach($j_pop as $jpop): ?>
            <div class="small-song-genre ms-4 col-md-8 row align-items-center">
              <div class="col-1 h3"></div>
                <div class="col d-flex">
                  <img class="rounded m-1" src="img/music/jpop/<?php echo $jpop['img']; ?>" style="width:50px;height:50px;object-fit:cover;">
                    <div class="ms-1 mt-1">
                      <div><?= $jpop['judul']; ?></div>
            ...
            <!-- Menu 3 -->
            <!-- Menu 2 -->
          <div class="tab-pane fade container" id="pills-kpop" role="tabpanel" aria-labelledby="pills-kpop-tab" tabindex="0">
            <div>
            <?php foreach($k_pop as $kpop): ?>
            <div class="small-song-genre ms-4 col-md-8 row align-items-center">
              <div class="col-1 h3"></div>
                <div class="col d-flex">
                  <img class="rounded m-1" src="img/music/kpop/<?php echo $kpop['img']; ?>" style="width:50px;height:50px;object-fit:cover;">
                    <div class="ms-1 mt-1">
                      <div><?= $kpop['judul']; ?></div>
